...
public class ShieldLibDamage {
    ...
    public static final ResourceKey<DamageType> HIT_SPIKED_SHIELD = ResourceKey.create(Registries.DAMAGE_TYPE, Identifier.fromNamespaceAndPath(ShieldLib.MOD_ID, "hit_spiked_shield"));
    public static final ResourceKey<DamageType> COLLIDE_SPIKED_SHIELD = ResourceKey.create(Registries.DAMAGE_TYPE, Identifier.fromNamespaceAndPath(ShieldLib.MOD_ID, "hit_spiked_shield"));
